...
table_name = os.environ.get('REDSHIFT_TABLE')

# host = 'data-engineer-cluster.cyhh5bfevlmn.us-east-1.redshift.amazonaws.com'
# port = 5439
# database = 'data-engineer-database'
# user = 'jbrekesdata_coderhouse'
# password = 'qHVZ6LI393'
# schema = 'jbrekesdata_coderhouse'
# table_name = 'daily_house_rent_listings'       

# In[13]:
# time.sleep(900) # Sleep for 3 seconds
